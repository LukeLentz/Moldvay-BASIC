...
let t2a = evaluate (IfC (BoolC true, FloatC 2.3, FloatC 4.3)) = (BoolT, Float 2.3)
let t2b = evaluate (IfC (IfC (BoolC false, BoolC false, BoolC true), IntC 2, IntC 4)) = (BoolT, Int 2)
